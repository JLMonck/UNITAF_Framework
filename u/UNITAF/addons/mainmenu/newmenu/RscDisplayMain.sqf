...
switch _mode do {
	...
	case "onLoad": {
		...
		uiNamespace setVariable ["UNITAF_mainmenu_display", _display];
		...
		// animate background UAV tiles
		// [_display] call BIS_fnc_guiEffectTiles;
		...
		(_display displayctrl 307307) ctrlSetFade 1;	//Addon Options
		...
		(_display displayctrl 307307) ctrlCommit 0;
		...
		(_display displayctrl 307307) ctrlEnable false;	//Addon Options
	...
	*/
	...
	case "playButton": {
		...
		if(uiNamespace getvariable "BIS_MainMenu_isPlayExpanded") then
		{
			...
			_control ctrlSetPosition [(1 * GUI_GRID_W + GUI_GRID_X), (9.4 * GUI_GRID_H + GUI_GRID_Y)];//9.3 //_offset
		...
		else
		{
			...
			//Game Logo
			_control = _display displayctrl 1202;
			_control ctrlSetPosition [(1 * GUI_GRID_W + GUI_GRID_X), ((5 + _offsetCampaign) * GUI_GRID_H + GUI_GRID_Y)];//6 //_offset //+ _offsetShowcases
			_control ctrlCommit _upperPartTime;
	...
	case "learnButton": {
		...
		else
		{
			...
			//Game Logo
			_control = _display displayctrl 1202;
			_control ctrlSetPosition [(1 * GUI_GRID_W + GUI_GRID_X), (2.9 * GUI_GRID_H + GUI_GRID_Y)];//2.7 //_offset
			_control ctrlCommit _upperPartTime;
	...
	case "optionsButton": {
		...
		if(uiNamespace getvariable "BIS_MainMenu_isOptionsExpanded") then
		{
			...
			//Game Logo
			_control = _display displayctrl 1202;
			_control ctrlSetPosition [(1 * GUI_GRID_W + GUI_GRID_X), (9.1 * GUI_GRID_H + GUI_GRID_Y)];//9.3 //_offset
			_control ctrlCommit _upperPartTime;
			...
			uiSleep _buttonsTime;
			(_display displayctrl 307307) ctrlCommit _buttonsTime;
			uiSleep _buttonsTime;
		...
		else
		{
			...
			//Game Logo
			_control = _display displayctrl 1202;
			_control ctrlSetPosition [(1 * GUI_GRID_W + GUI_GRID_X), (1.7 * GUI_GRID_H + GUI_GRID_Y)];//2.7 //_offset
			_control ctrlCommit _upperPartTime;
			
			//Title background
			_control = _display displayctrl 1050;
			_control ctrlSetPosition [(1 * GUI_GRID_W + GUI_GRID_X), (6.5 * GUI_GRID_H + GUI_GRID_Y)];//6.5 //_offset 
			_control ctrlCommit _upperPartTime;
			...
			//Player's name
			_control = _display displayctrl 109;
			_control ctrlSetPosition [(6 * GUI_GRID_W + GUI_GRID_X), (6.5 * GUI_GRID_H + GUI_GRID_Y)];//6.5 //_offset
			_control ctrlCommit _upperPartTime;
			...
			(_display displayctrl 307) ctrlEnable true;	//Game Options
			(_display displayctrl 307307) ctrlEnable true;	//Addon Options
			(_display displayctrl 1001) ctrlEnable true;	//Profile
			(_display displayctrl 140) ctrlEnable true;	//Expansions
			...
			(_display displayctrl 307307) ctrlSetFade 0;	//Addon Options
			...
			uiSleep _buttonsTime;
			(_display displayctrl 307307) ctrlCommit 0.1;	//Addon Options
			uiSleep _buttonsTime;
