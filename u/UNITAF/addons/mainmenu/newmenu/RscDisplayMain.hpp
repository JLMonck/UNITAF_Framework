...
class RscDisplayMain: RscStandardDisplay
{
	...
	scriptPath="UNITAF_NewMenu";
	movingEnable = 0;
	access = 0;
	onLoad = "[""onLoad"",_this,""RscDisplayMain"",'UNITAF_NewMenu'] call (uiNamespace getVariable 'BIS_fnc_initDisplay')";
	onUnload = "[""onUnload"",_this,""RscDisplayMain"",'UNITAF_NewMenu'] call (uiNamespace getVariable 'BIS_fnc_initDisplay')";
	class controlsBackground
	{
		...
		class BackgroundPicture: RscPictureKeepAspect {
			idc = 420001;
			text = "\u\unitaf\addons\mainmenu\data\background\background1.paa";
			x = "safezoneX";
			y = "safezoneY";
			w = "safezoneW";
			h = "safezoneH";
	...
	class controls
	{
		...
		class SpotlightJoinMain: RscControlsGroupNoScrollbars
		{
			...
			y = "29 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 			(safezoneY)";
			...
			class Controls
			{
				...
				{
					idc=1025;
					fade=0;	// doesn't work with 'onMouseEnter' / 'onMouseExit'
					x=0;
					y=0;
					w = "8 * 			(			((safezoneW / safezoneH) min 1.2) / 40)";
					h = "8 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
				...
				class Button: RscButton
				{
					...
					w = "8 * 			(			((safezoneW / safezoneH) min 1.2) / 40)";
					h = "8 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					onButtonClick = "[[(_this select 0)], '88.99.211.37', '2402', ''] call unitaf_main_fnc_joinServer";
				};
			};
		};
		// Quick Join Lib Server
		class SpotlightJoinLib: RscControlsGroupNoScrollbars
		{
			//fade=1;
			x = "26 * 			(			((safezoneW / safezoneH) min 1.2) / 40) + 			(safezoneX)";
			y = "29 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 			(safezoneY)";
			w = "8 * 			(			((safezoneW / safezoneH) min 1.2) / 40)";
			h = "8 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
			class Controls
			{
				...
				class Button: RscButton
				{
					...
					w = "8 * 			(			((safezoneW / safezoneH) min 1.2) / 40)";
					h = "8 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
					onButtonClick = "[[(_this select 0)], '88.99.211.37', '2302', ''] call unitaf_main_fnc_joinServer";
				};
			};
		};
		*/
		...
		class GameLogo: RscPictureKeepAspect
		{
			...
			text = "\u\unitaf\addons\mainmenu\data\UTFN.paa";
			x = "1 * 			(			((safezoneW / safezoneH) min 1.2) / 40) + 			(safezoneX)";
			y = "9.4 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 			(safezoneY + safezoneH - 			(			((safezoneW / safezoneH) min 1.2) / 1.2))";
			//w = "7.5 * 			(			((safezoneW / safezoneH) min 1.2) / 40)";
			w = "15 * 			(			((safezoneW / safezoneH) min 1.2) / 40)";
			h = "4.75 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
		...
		class ButtonAddon: RscButtonMenu
		{
			idc = 307307;
			text = "Addon Options";
			x = "2 * 			(			((safezoneW / safezoneH) min 1.2) / 40) + 			(safezoneX)";
			...
			w = "14 * 			(			((safezoneW / safezoneH) min 1.2) / 40)";
			h = "1 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
			tooltip = "Adjust addon settings.";
			onbuttonclick = QUOTE(ctrlParent (_this select 0) call CBA_settings_fnc_openSettingsMenu);
		};
		...
		{
			idc = 147;
			text = "\u\unitaf\addons\mainmenu\data\ModIconsBackground_ca.paa";
			x = "17 * 			(			((safezoneW / safezoneH) min 1.2) / 40) + 			(safezoneX)";
			y = "17.5 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 			(safezoneY + safezoneH - 			(			((safezoneW / safezoneH) min 1.2) / 1.2))";
		...
		{
			idc = 148;
			text = "\u\unitaf\addons\mainmenu\data\OwnedDLCIconsBackground_ca.paa";
			x = "17 * 			(			((safezoneW / safezoneH) min 1.2) / 40) + 			(safezoneX)";
			y = "19.7 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 			(safezoneY + safezoneH - 			(			((safezoneW / safezoneH) min 1.2) / 1.2))";
			w = "8.4 * 			(			((safezoneW / safezoneH) min 1.2) / 40)";
			h = "2.1 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
		...
		class DLCIconsBackground: RscPicture
		{
			idc = 146;
			y = "safezoneY + (1 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25))";
			text = "\u\unitaf\addons\mainmenu\data\DLCIconsBackground_ca.paa";
			x = "1 * 			(			((safezoneW / safezoneH) min 1.2) / 40) + 			(safezoneX)";
			w = "8.4 * 			(			((safezoneW / safezoneH) min 1.2) / 40)";
			h = "2.1 * 			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
		};
