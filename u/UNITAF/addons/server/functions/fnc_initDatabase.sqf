...
if (!(parseSimpleArray (_result) select 0 isEqualTo 1)) exitWith { diag_log "extDB3: Error with Database Connection"; false };

//Get Protocol
_result = "extDB3" callExtension "9:ADD_DATABASE_PROTOCOL:UTFN:SQL:FETCHDATA:TEXT";
if (!(parseSimpleArray (_result) select 0 isEqualTo 1)) exitWith { diag_log "extDB3: Error with Protocol Connection"; false };
